...
class Retrofit(private val dependencyHandler: DependencyHandler) {
    ...
    fun basicRequired(version: String = LATEST_VERSION): Retrofit {
...
class Okhttp(private val dependencyHandler: DependencyHandler) {
    ...
    fun basicRequired(version: String = LATEST_VERSION) : Okhttp {
        implementationBom(version)
        implementationOkhttpWithLoggingInterceptor()
        return this
    }

    fun implementationBom(version: String = LATEST_VERSION) : Okhttp {
